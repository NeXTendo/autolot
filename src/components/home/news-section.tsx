        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-24">
          ...
          {featureStory && (
            <div className="lg:col-span-8 group relative aspect-16/10 lg:aspect-auto overflow-hidden border border-white/5">
              <Link href={`/stories/${featureStory.slug}`} className="block h-full">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-black via-black/20 to-transparent p-6 md:p-12 flex flex-col justify-end">
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            {sideStories.map((story) => (
              ...
              >
                <div className="relative w-24 h-24 md:w-32 md:h-32 shrink-0 overflow-hidden border border-white/5">
                  <Image
